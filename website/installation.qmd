...
- A Linux x86_64 machine with at least 20 GB free for the public input downloads, plus additional space for the extracted reference, pixi environment, target store, and generated outputs.
- `git`.
...
Then download and unpack the matching human Cell Ranger ARC reference (14.9 GB).
