...
Use the [Quickstart: Public PBMC demo](demo_installation.qmd) if you want to install multiomeR, run a focused public example, and inspect representative outputs before reading the full pipeline walkthroughs.
