...
- **Single-nucleus enrichment**
  - [`chromVAR`](https://greenleaflab.github.io/chromVAR/articles/Introduction.html) / [`gchromVAR`](https://caleblareau.github.io/gchromVAR/reference/index.html) z-scores retained as internal inputs for SCAVENGE seed selection.
  - [`SCAVENGE`](https://github.com/sankaranlab/SCAVENGE) trait relevance scores summarized across clusters and cell types.
  - Per-nucleus UMAPs, cluster-level TRS heatmaps, score intervals, and significant-cell proportions.

- **Graph-based enrichment**
  - Trait-score propagation across PCA, LSI, and WNN graph representations.
