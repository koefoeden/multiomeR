...
panel_specs <- tibble::tribble(
  ...
  "2"            , "E"  , quote(targets::tar_read(ZScores_heatmap.trait_level.pseudobulk.genetic_enrichment.mixed_human_7x))                  , NA_character_                , NA_character_ , "Pseudobulk GWAS chromVAR Z-scores across PBMC cell types and GWAS traits."                       , quote(figure_2_GWAS_heatmap_panel(plot))     ,
)
