...
The public PBMC demo uses two public human `cellranger-arc count` outputs: `healthy_PBMC_human` and `lymphoma_lymph_human`. Download them from the repository root:
...
Then download and unpack the matching human Cell Ranger ARC reference:
