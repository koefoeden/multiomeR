...
panel_specs <- tibble::tribble(
  ...
  "2"            , "E"  , quote(targets::tar_read(chromVAR_deviation_heatmap.trait_level.pseudobulk.genetic_enrichment.mixed_human_7x))       , NA_character_                , NA_character_ , "Cell-type GWAS chromVAR relative deviations with z-score support and nuclei counts."             , quote(figure_2_GWAS_heatmap_panel(plot))     ,
)
