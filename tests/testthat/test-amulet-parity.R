...
testthat::test_that("integration: the BPCells-native AMULET ABI is available", {
  load_amulet_test_runtime()
  testthat::expect_no_error(validate_amulet_BPCells_native_abi())
})
...
testthat::test_that("integration: AMULET metrics match the bundled fragment reference", {
  load_amulet_test_runtime()
...
testthat::test_that("integration: multi-chromosome AMULET loci and metrics match", {
  load_amulet_test_runtime()
  set.seed(20260712)
  n_fragments <- 12000L
